...
/**
 * Sequencer UI for the Redstone Programmer. Renders a channel-major timeline (rows = channel,
...
public class RedstoneProgrammerScreen extends AbstractSimiContainerScreen<RedstoneProgrammerMenu> {
    ...
    public void containerTick() {
        ...
        // Sync to server
        if (shouldSend) {
            CatnipServices.NETWORK.sendToServer(new RedstoneProgramSyncC2SPacket(program));
            shouldSend = false;
        }
    }
