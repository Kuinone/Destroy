...
/**
 * Block-Entity Renderer for the Redstone Programmer — animated cylinder + needle + per-channel
 * transmitter partials driven by the channel sequencer's playtime + power state.
 *
 * <p><strong>Zero new Rule</strong> — straightforward 1:1 port. Package migration only.</p>
*/
public class RedstoneProgrammerBlockEntityRenderer extends SafeBlockEntityRenderer<RedstoneProgrammerBlockEntity> {
    ...
    @Override
    protected void renderSafe(RedstoneProgrammerBlockEntity be, float partialTicks, PoseStack ms,
