...
/**
 * Flywheel visual for the Pumpjack — 4 {@link TransformedInstance}s (cam + linkage + beam +
 * pump) animated each frame based on {@link PumpjackBlockEntity#getRenderAngle()}. When Flywheel
 * visualization is enabled, this path replaces {@link PumpjackRenderer}'s per-frame buffer draw.
*/
