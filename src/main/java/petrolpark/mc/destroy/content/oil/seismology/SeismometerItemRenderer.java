...
/**
 * Custom renderer for {@link SeismometerItem} — shows an analog needle seismometer with animated
 * spike pages. When the player holds the Seismometer (main-hand, or off-hand if main-hand is empty
 * of another Seismometer), it animates: a {@link LerpedFloat} angular needle chases 4-phase
 * targets every 32 ticks, and the currently-visible page alternates between {@code PAGE_LEVEL}
 * (flat reading) and {@code PAGE_SPIKE} (jagged reading).
*/
public class SeismometerItemRenderer extends CustomRenderedItemModelRenderer {
    ...
    private static int spikeNextPage; // Whether the next page to show should have a spike on it
    ...
    /**
 * Trigger a spike on the next 32-tick animation cycle.
*/
    ...
    protected void render(ItemStack stack, CustomRenderedItemModel model, PartialItemModelRenderer renderer,
        ...
        boolean noControllerInMain = !DestroyItems.SEISMOMETER.isIn(player.getMainHandItem());
