...
/**
 * Block-Entity Renderer for the Keypunch — draws the selected-position piston at its configured
 * (x, y) grid cell with a Y-translation driven by {@link CircuitPunchingBehaviour#getRenderedPistonOffset
 * CircuitPunchingBehaviour.getRenderedPistonOffset(partialTicks)}. Also overrides
 * {@link #getRotatedModel} to render a SHAFTLESS cogwheel (the Keypunch's Y-axis cog) in place of
 * the default shaft.
*/
