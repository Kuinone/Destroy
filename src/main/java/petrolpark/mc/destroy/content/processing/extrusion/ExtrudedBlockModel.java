...
/**
 * Dynamic BakedModel for the progressive extrusion animation — renders the extruded block with
 * its geometry scaled along the movement axis based on progress (0..1). Used by
 * {@link ExtrudableMovementBehaviour#renderInContraption} (currently dropped in 1.21 port, Rule
 * #159 — re-enable this visual by restoring that override once the Flywheel contraption
 * rendering pipeline is integrated).
*/
