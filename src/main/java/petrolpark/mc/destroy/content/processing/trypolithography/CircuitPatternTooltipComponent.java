...
/**
 * Tooltip component for {@link CircuitPatternItem} subclasses (CircuitBoardItem, CircuitMaskItem)
 * — renders a 4×4 circuit pattern visualization (border + punched cells) when the item is hovered.
 * Carries the packed pattern int + 3 {@link ScreenElement}s (border, tile, tile-border) + an
 * orientation flag controlling z-order between border and tile overlays.
*/
public class CircuitPatternTooltipComponent
    extends DestroyTooltipComponent<CircuitPatternTooltipComponent, CircuitPatternTooltipComponent.ClientCircuitPatternTooltip> {
    ...
    public CircuitPatternTooltipComponent(int pattern, boolean tileBorderOnTop, ScreenElement border,
                                          ScreenElement tile, ScreenElement tileBorder) {
    ...
    public static void renderCircuitMask(GuiGraphics graphics, int pattern, boolean tileBorderOnTop,
                                         ScreenElement border, ScreenElement tile, ScreenElement tileBorder) {
