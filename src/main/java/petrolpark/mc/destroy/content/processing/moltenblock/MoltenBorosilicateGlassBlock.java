...
public class MoltenBorosilicateGlassBlock extends AbstractMoltenBlock {
    ...
    public boolean skipRendering(BlockState state, BlockState adjacentState, Direction side) {
        return DestroyBlocks.MOLTEN_BOROSILICATE_GLASS.has(adjacentState)
            || (DestroyBlocks.BOROSILICATE_GLASS_FIBER.has(adjacentState) && adjacentState.getValue(FastCoolingMoltenPillarBlock.MOLTEN))
