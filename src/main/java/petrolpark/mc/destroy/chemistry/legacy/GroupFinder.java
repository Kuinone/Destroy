...
/**
 * A class whose purpose is to locate {@link LegacyFunctionalGroup functional Groups} in {@link LegacySpecies Molecules}.
...
*/
    ...
    /**
 * All Group Finders known to Destroy.
 * <p>This is called by a {@link LegacySpecies Molecule} when identifying which {@link LegacyFunctionalGroup} Groups
 * a Molecule contains. There should be no need to call this otherwise.</p>
*/
 ...
 * @param structure A Map of {@link LegacyAtom Atoms} to all {@link LegacyBond Bonds} that Atom has
 * (see the {@code structure} property of {@link LegacyMolecularStructure})
...
*/
    ...
    /**
 * A convenience method that gives all {@link LegacyAtom Atoms} of the given {@link LegacyElement} bonded
 * (with any {@link LegacyBond.BondType type}) to the given Atom in the given structure.
 *
 * @param structure A Map of Atoms in a {@link LegacySpecies} to all Bonds that Atom has
...
*/
    public static List<LegacyAtom> bondedAtomsOfElementTo(Map<LegacyAtom, List<LegacyBond>> structure,
                                                          LegacyAtom atom, LegacyElement element) {
    ...
    /**
 * A convenience method that gives all {@link LegacyAtom Atoms} of the given {@link LegacyElement} bonded
 * (with the given {@link LegacyBond.BondType type}) to the given Atom in the given structure.
 *
 * @param structure A Map of Atoms in a {@link LegacySpecies} to all Bonds that Atom has
 * @param atom The Atom to which to check for Bonds
 * @param element The Element to check for
...
*/
    public static List<LegacyAtom> bondedAtomsOfElementTo(Map<LegacyAtom, List<LegacyBond>> structure,
                                                          LegacyAtom atom, LegacyElement element, BondType bondType) {
        List<LegacyAtom> atoms = new ArrayList<>();
        for (LegacyBond bond : structure.get(atom)) {
            LegacyAtom destAtom = bond.getDestinationAtom();
