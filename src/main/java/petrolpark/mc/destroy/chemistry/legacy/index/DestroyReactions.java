...
public class DestroyReactions {
    ...
    ACETYLENE_TRIMERIZATION = builder()
        ...
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/nickel"), 1f)
    ...
    ANDRUSSOW_PROCESS = builder()
        ...
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/platinum"), 1f)
    ...
    ANTHRAQUINONE_REDUCTION = builder()
        ...
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/palladium"), 1f)
    ...
    BORAX_DISSOLUTION = builder()
        ...
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("raw_materials/borax"), 15f)
    ...
    CHROMIUM_DISSOLUTION = builder() // TODO replace with redox
        ...
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/chromium"), 4.5f)
    ...
    CISPLATIN_SYNTHESIS = builder()
        ...
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/platinum"), 2f)
    ...
    CONTACT_PROCESS = builder()
        ...
        .addReactant(DestroyMolecules.OXYGEN)
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/platinum"), 3f)
    ...
    COPPER_DISSOLUTION = builder() // TODO replace with redox
        ...
        .addReactant(DestroyMolecules.PROTON, 2, 1)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/copper"), 9f)
        .addProduct(DestroyMolecules.HYDROGEN)
    ...
    IRON_DISSOLUTION = builder() // TODO replace with redox
        .id("iron_dissolution")
        .addReactant(DestroyMolecules.PROTON, 6, 1)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/iron"), 4.5f)
        .addProduct(DestroyMolecules.HYDROGEN, 3)
    ...
    LEAD_DISSOLUTION = builder() // TODO replace with redox
        .id("lead_dissolution")
        .addReactant(DestroyMolecules.PROTON, 2, 1)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/lead"), 9f)
        .addProduct(DestroyMolecules.HYDROGEN)
        .addProduct(DestroyMolecules.LEAD_II)
        .build(),
    ...
    LIME_SLAKING = builder()
        .id("lime_slaking")
        .addReactant(DestroyMolecules.WATER)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/lime"), 2f)
        .addProduct(DestroyMolecules.CALCIUM_ION)
        .addProduct(DestroyMolecules.HYDROXIDE, 2)
        .build(),
    ...
    METHANOL_SYNTHESIS = builder()
        ...
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/copper"), 1f)
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/zinc"), 1f)
    ...
    NICKEL_DISSOLUTION = builder() // TODO replace with redox
        ...
        .addReactant(DestroyMolecules.PROTON, 2, 1)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/nickel"), 9f)
        .addProduct(DestroyMolecules.HYDROGEN)
    ...
    OSTWALD_PROCESS = builder()
        ...
        .addSimpleItemTagCatalyst(PetrolparkTags.commonItemTag("dusts/rhodium"), 1f)
        .addProduct(DestroyMolecules.WATER)
    ...
    SODIUM_AMALGAMIZATION = builder()
        ...
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("ingots/sodium"), 9.9f) // One sodium ingot = 10 moles of sodium atoms
    ...
    TETRAETHYLLEAD_SYNTHESIS = builder()
        ...
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/lead"), 2.5f)
    ...
    ZINC_DISSOLUTION = builder() // TODO replace with redox
        .id("zinc_dissolution")
        .addReactant(DestroyMolecules.PROTON, 2, 1)
        .addSimpleItemTagReactant(PetrolparkTags.commonItemTag("dusts/zinc"), 9f)
        .addProduct(DestroyMolecules.HYDROGEN)
