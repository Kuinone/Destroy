...
/**
 * Animated 3D model of the Mechanical Sieve for JEI recipe categories — renders MECHANICAL_SIEVE
 * block + spinning shaft + rocking linkages + sifting sieve tray with sinusoidal Z-axis offset
 * for the classic sieve motion.
*/
