...
/**
 * JEI category for {@link ObliterationRecipe} · displays which blocks yield which loot when
 * obliterated by a custom explosive mix detonation. Display-only — recipes never match at
 * runtime (loot-table driven).
*/
