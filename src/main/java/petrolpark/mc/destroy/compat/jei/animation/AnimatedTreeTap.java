...
/**
 * Animated 3D model of the TreeTap for JEI recipe categories — renders the TREE_TAP block with
 * spinning shaft + sinusoidally-rocking TREE_TAP_ARM partial on top.
*/
