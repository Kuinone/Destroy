...
/**
 * JEI category for {@link ChargingRecipe} · displays Belt/World-mode charging (single item
 * input → 1+ item outputs) with an animated Dynamo at the top of the category frame.
*/
