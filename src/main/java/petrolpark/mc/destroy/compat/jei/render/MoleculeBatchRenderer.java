package petrolpark.mc.destroy.compat.jei.render;
...
/**
 * JEI batch renderer for Molecule ingredients — draws each molecule's ball-and-stick into the
 * shared GuiGraphics buffer, then overlays a charge label (+, 2-, etc.) in a custom font.
*/
