...
/**
 * JEI icon overlay combining a miniature {@link AnimatedDynamo} (configured as basin=false,
 * arcFurnace=true · top-pose only) with an item overlay. Used by {@code ArcFurnaceCategory}'s
 * category tab icon to convey "arc furnace + X material" semantic.
*/
