...
/**
 * JEI category for {@link ElementTankFillingRecipe} · displays the fluid input at top, the
 * ELEMENT_TANK catalyst item in the middle, and the resulting element-sample block as output.
*/
