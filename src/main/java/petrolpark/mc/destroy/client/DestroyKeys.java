...
/**
 * Extra hotbar slot keybinds (slots 10-17) registered with the vanilla {@link KeyMapping} system.
 * Bindings are consumed by the hotbar mixins / screen extensions that surface the extra slots in
 * the player's UI.
*/
