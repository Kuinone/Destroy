...
/**
 * Full Mixed-Explosive GUI screen — background + explosive-ingredient slots + player inventory +
 * {@link ExplosivePropertiesTooltip} chart + confirm button.
*/
public class MixedExplosiveScreen extends AbstractSimiContainerScreen<MixedExplosiveMenu> {
    ...
    protected void init() {
        ...
        // JEI "view mixable explosives" button deferred — CompatMods + MixableExplosiveCategory
        // not ported to 1.21 tree yet.
    }
    ...
    protected void renderForeground(GuiGraphics graphics, int mouseX, int mouseY, float partialTicks) {
        ...
        // Hover tooltip for ExplosiveProperties chart
        if (explosiveProperties != null) {
            List<Component> tooltip = ExplosivePropertiesTooltip
                .getSelected(explosiveProperties, mouseX - getGuiLeft() - 10, mouseY - getGuiTop() - 22)
                .getTooltip(explosiveProperties);
