        ...
        switch (be.getDisplayType()) {
            case PIPE: {
                ...
                if (facing == Direction.DOWN) {
                    NeoForgeCatnipServices.FLUID_RENDERER.renderFluidBox(be.spoutingFluid,
                        6.5f / 16f, fluidLevel - be.getVatOptional().get().getInternalHeight(), 6.5f / 16f,
                    ...
                    ms.translate(-0.5, -0.5, -0.5);
                    NeoForgeCatnipServices.FLUID_RENDERER.renderFluidBox(be.spoutingFluid,
                        6.5f / 16f, 4 / 16f, 17 / 16f,
                        9.5f / 16f, 6 / 16f, 19 / 16f,
                        bufferSource, ms, light, false, true);
                    NeoForgeCatnipServices.FLUID_RENDERER.renderFluidBox(be.spoutingFluid,
                        6.5f / 16f, fluidLevel - be.pipeHeightAboveVatBase() + 4 / 16f, 19 / 16f,
            ...
            case THERMOMETER: {
                ...
                Vec3 v3 = new Vec3(8.5f / 16f,
                    (10.1f * Mth.clamp((controller.getClientTemperature(partialTicks) - 298f) / 202f, 0, 1) + 3.9f) / 16f,
                    -0.5f / 16f);
                NeoForgeCatnipServices.FLUID_RENDERER.renderFluidBox(THERMOMETER_FLUID,
