...
/**
 * Ponder scene overlay instruction that draws an animated thermometer gauge pointing at a
 * scene-space point, animating between temperature values (0f–1f where 0f = coldest blue
 * gradient and 1f = hottest red gradient). Used by future Vat temperature scenes
 * ({@code vatTemperature / roomTemperature}) in {@code ChemistryPonderScenes}.
*/
