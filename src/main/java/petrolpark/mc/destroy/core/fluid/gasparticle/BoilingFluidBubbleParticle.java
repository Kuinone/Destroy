...
/**
 * Bubble particle that rises from boiling fluid surfaces. Animated sprite frames 0-5 at fixed
 * intervals + pop animation in last 6 ticks.
*/
public class BoilingFluidBubbleParticle extends FluidStackParticle {

    protected final SpriteSet spriteSet;

    public BoilingFluidBubbleParticle(ClientLevel world, FluidStack fluid,
    ...
    public static class Provider implements ParticleProvider<BoilingFluidBubbleParticleData> {
        ...
        @Override
        @Nullable
        public Particle createParticle(BoilingFluidBubbleParticleData data, ClientLevel level,
                                       double x, double y, double z,
                                       double vx, double vy, double vz) {
